function init()
{
    ...
    enemy1 = new Enemy("enemy1", 0xff0000, new THREE.Vector2(100, 50), 0);
    enemy1.graphic.position.x = 60;
    enemy1.graphic.position.y = -100;
...
{
    pointLight = new THREE.PointLight(color, 50, 35000);
